...
async def get_all_campanias(db: AsyncIOMotorClient = Depends(get_db(resource="resource1", method="GET"))) -> Doctor:
    ...
    try:
        ...
        result = await db["campaign"].find_one({"_id": ObjectId(id)})
